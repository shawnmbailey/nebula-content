...
const word22 = "also";
const word23 = "like"; 
const savedtemplateliteral = ` ${word1} ${word4}, ${word17} ${word23} ${word2} ${word10}`; 
console.log(savedtemplateliteral);
// 4. Given the string of your full name get your initials.
const myName = "Shawn Michael Bailey";
console.log(myName[0] +myName[6] +myName[14]);


// 5. Get the 5th character from the following string: 'Hello World'
const greeting1 = 'Hello World'
console.log(greeting1[6]); 
